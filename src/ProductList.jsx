...
function ProductList() {
  ...
  const [addedToCart, setAddedToCart] = useState({}); // Estado para rastrear productos añadidos al carrito
  ...
  const handleAddToCart = (plant) => {
    dispatch(addItem(plant)); // Agregar al carrito global usando Redux
    setAddedToCart((prevState) => ({
      ...prevState,
      [plant.name]: true, // Marcar la planta como añadida al carrito
    }));
  };
  ...
  const handlePlantsClick = (e) => {
    e.preventDefault();
    setShowCart(false); // Mostrar la lista de plantas
  };
  ...
  const handleRemoveFromCart = (name) => {
    setAddedToCart((prevState) => ({
      ...prevState,
      [name]: false, // Desmarca la planta como añadida
    }));
  };
  ...
  return (
    <div>
      ...
      {!showCart ? (
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button
                      className={`product-button ${addedToCart[plant.name] ? 'addedtocart' : ''}`}
        ...
        onUpdateProductState={handleRemoveFromCart}
        />
      )}
    </div>
  );
